...
export const fetchInactive = () => fetchJson<Member[]>('/api/inactive')

export const fetchStats = () => fetchJson<Stats>('/api/stats')

export const setMemberInactive = (userId: number, isInactive: boolean) =>
  fetchJson<{ ok: boolean }>(`/api/members/${userId}/inactive`, {
    method: 'POST',
